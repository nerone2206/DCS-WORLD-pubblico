--stringa completa
--AwacsStennis=RECOVERYTANKER:New(UNIT:FindByName("stennis"), "awacs")-- i nomi devono essere uguli, cioè nome gruppo ed unità
local AwacsStennis=RECOVERYTANKER:New("STENNIS", "AWACS")-- script per l'awacs
AwacsStennis:SetAWACS()
AwacsStennis:SetTakeoffCold ()
AwacsStennis:SetAltitude (25000)
AwacsStennis:SetSpeed (230)
AwacsStennis:SetRacetrackDistances ( 15 , 10 )
--AwacsStennis:SetTACAN(7, "TEX")
AwacsStennis:Start()
